<template>
  <ul class="c-sidebar-nav">
    ...
    <li
      ...
      v-if="hasAnyPermission(['categories.index'])"
    >
      <Link
        class="c-sidebar-nav-link"
    ...
    <li
      class="c-sidebar-nav-title"
      v-if="hasAnyPermission(['transactions.index'])"
    >
      TRANSACTIONS
    </li>
    ...
    <li
      class="c-sidebar-nav-title"
      v-if="
        hasAnyPermission(['sales.index']) || hasAnyPermission(['profits.index'])
      "
    >
      REPORTS
    </li>
    <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions-list.index'])">
      <Link
        class="c-sidebar-nav-link"
        href="/apps/transactions-list"
        :class="{ active: $page.url.startsWith('/apps/transactions-list') }"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
        ...
        <span class="ms-2">Transactions List</span>
      </Link>
    </li>
