...
export default {
  ...
  setup(props) {
    ...
    const endDate = new Date(nextYear, 10, 1); // Akhir tahun selanjutnya
    const formattedEndDate = endDate.toLocaleDateString();
    return {
      description: `Langganan ini berlaku dari ${currentDate.toLocaleDateString()} S.D. ${formattedEndDate}`,
      barcode,
      product,
      searchProduct,
      clearSearch,
