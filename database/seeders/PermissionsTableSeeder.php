...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'transactions-list.index', 'guard_name' => 'web']);
        Permission::create(['name' => 'transactions-list.delete', 'guard_name' => 'web']);
        Permission::create(['name' => 'transactions-list.print', 'guard_name' => 'web']);
